...
def init_db():
    ...
    CREATE TABLE IF NOT EXISTS interviews (
        ...
        welcome_msg TEXT DEFAULT 'Welcome! This interview consists of a few video questions. Take your time and be yourself.',
        thank_you_msg TEXT DEFAULT 'Thank you for completing your interview! We will review your responses and be in touch soon.',
        brand_color TEXT DEFAULT '#0ace0a',
